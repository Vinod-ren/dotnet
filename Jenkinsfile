...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 021891598588.dkr.ecr.ap-south-1.amazonaws.com/vinod
	 docker build -t 021891598588.dkr.ecr.ap-south-1.amazonaws.com/vinod:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 021891598588.dkr.ecr.ap-south-1.amazonaws.com/vinod:SAMPLE-PROJECT-${BUILD_NUMBER}
    ...
    stage('Deploy  K8'){
		  ...
		  chmod +x changebuildnumber.sh
                  ...
                  aws eks --region ap-south-1 update-kubeconfig --name vinod
                  cat deployment.yml
